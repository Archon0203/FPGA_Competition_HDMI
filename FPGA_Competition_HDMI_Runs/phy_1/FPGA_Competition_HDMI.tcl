...
set rc [catch {
  route
  report_area -io_info -file FPGA_Competition_HDMI_phy.area
  export_db {FPGA_Competition_HDMI_pr.db}
  start_timer
  report_timing -mode FINAL -net_info  -rpt_autogen true -file FPGA_Competition_HDMI_phy.timing
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid FPGA_Competition_HDMI_inst.bid
  bitgen -bit "FPGA_Competition_HDMI.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
