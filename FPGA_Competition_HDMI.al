...
<Project Version="3" Minor="2" Path="D:/AnlogicProject/FPGA_Competition_HDMI">
    ...
    <Source_Files>
        <Verilog>
            ...
            <File Path="src/display/hdmi_test_pattern_line_provider.v">
                <FileInfo>
            ...
            <File Path="src/display/hdmi_video_adapter.v">
                <FileInfo>
                    <Attr Name="AutoExcluded" Val="true"/>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
            ...
            <File Path="src/top/p1_hx4s20c_hdmi_board_top.v">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="design_1"/>
        ...
        <SDC_FILE>
            <File Path="constraints/p1_hx4s20c_hdmi_board.sdc">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="constraint_1"/>
    ...
    <TOP_MODULE>
        <LABEL>p1_hx4s20c_hdmi_board_top</LABEL>
        <MODULE>p1_hx4s20c_hdmi_board_top</MODULE>
    ...
    <Project_Settings>
        <Step_Last_Change>2026-09-11 00:00:00</Step_Last_Change>
