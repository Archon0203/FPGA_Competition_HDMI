...
2. HDMI reset release in `p1_hx4s20c_sdram_hdmi_top` now occurs on the 50 MHz falling edge to move reset deassertion away from the 25 MHz pixel rising edge. The hold duration remains approximately 20 ms.
